...
(def-doom-theme doom-elly
  ...
  ((bg         '("#111A1F" nil       nil            ))
   ...
   (base0      '("#121415" "#121212" "black"        ))
   (base1      '("#24292B" "#262626" "brightblack"  ))
   (base2      '("#363D40" "#3A3A3A" "brightblack"  ))
   (base3      '("#485256" "#4E4E4E" "brightblack"  ))
   (base4      '("#5A666B" "#626262" "brightblack"  ))
   (base5      '("#6C7A80" "#767676" "brightblack"  ))
   (base6      '("#808E94" "#8A8A8A" "brightblack"  ))
   (base7      '("#95A1A6" "#9E9E9E" "brightblack"  ))
   (base8      '("#ABB4B8" "#B2B2B2" "white"        ))
   (fg-alt     '("#CDD2D5" "#D0D0D0" "brightwhite"  ))
   (fg         '("#C0C7CA" "#C6C6C6" "white"        ))
