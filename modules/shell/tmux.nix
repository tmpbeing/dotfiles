...
in {
  ...
  config = mkIf cfg.enable {
    ...
    home.configFile = {
      ...
      "tmux/extraInit".text = ''
        # This file is auto-generated by niuxos, don't edit it by hand!
        run-shell ${pkgs.tmuxPlugins.copycat}/share/tmux-plugins/copycat/copycat.tmux
        run-shell ${pkgs.tmuyxPlugins.prefix-highlight}/share/tmux-plugins/prefix-highlight/prefix_highlight.tmux
