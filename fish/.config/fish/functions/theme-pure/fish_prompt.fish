...
__pure_set_default pure_symbol_prompt "λ"
...
function fish_prompt
  ...
  set prompt $prompt "$pure_color_magenta$current_folder$pure_color_normal "
  ...
  if test -n "$is_git_repository"
    ...
    set prompt $prompt "$pure_color_blue$git_branch_name$git_dirty$pure_color_normal$pure_color_cyan$git_arrows$pure_color_normal "
  end
